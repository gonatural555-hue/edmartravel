...
export default function PremiumExperienceCtaCard({
  ...
  return (
    ...
    >
      ...
      />
      <h3
        className={`relative font-theater font-bold uppercase leading-[1.05] tracking-[-0.04em] text-[#3D2E24] ${
      ...
      <p
        className={`relative mt-2 font-sans text-[#5C4A3A]/75 leading-relaxed tracking-[0.02em] ${
